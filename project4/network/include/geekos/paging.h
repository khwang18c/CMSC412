...
/* Important linear address locations */
#define USER_START_KERNEL 0x00000000
#define USER_VM_START     0x80000000
#define USER_TEXT         0x80001000
#define USER_STACK        0xFFFFE000
#define USER_ARGS         0xFFFFF000
#define USER_VM_END       0xFFFFFFFF

#define LOGICAL_TO_LINEAR(x) ((x) + USER_VM_START)
...
pde_t *g_pageDir; // Global kernel page directory 
pagefile *g_pagefile; // Global page file 
