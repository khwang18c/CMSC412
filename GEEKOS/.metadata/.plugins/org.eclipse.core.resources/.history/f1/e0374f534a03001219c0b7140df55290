...
#define MAX_TLOCAL_KEYS 128
    ...
    /* Queue that thread is currently waiting in */
    struct Thread_Queue *currentQueue;

    /* Used to check if thread's process tree contains a detached thread */
    int backgrounded;
...
/* Function that fills ptable with all process information */
